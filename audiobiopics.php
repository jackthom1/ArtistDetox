<?php 
define("PAGE_TITLE", "Audio Biopics");
include("./header.php")  ?>


<div class="audiobiopics">
    <div class="titleSection">

        <h1>Audiobiopics</h1>
        <h3>Listen Back to all my Audiobiopics</h3>
    </div>
    ...
    <?php 
            ...
            //    $con = new mysqli("localhost", "root", "");
               if ($con->connect_error){
                ...
                $sql = "SELECT * FROM `epiz_27180315_blog`.`posts` WHERE `postCatagory`='audiobiopic' ORDER BY `postDate` DESC";
